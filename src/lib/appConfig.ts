export const appConfig = {
  companyName: import.meta.env.VITE_COMPANY_NAME || "NXQ",
...
export const clientDomainPolicy = {
  ...
  summary: "Clients purchase, own, and renew their own domains. NXQ only provides connection instructions, verifies DNS, and monitors SSL.",
};
