...
export function ClientBusinessLocations() {
  ...
  async function load() {
    ...
    setLocations(((result.data as { locations?: Location[] } | null)?.locations) || []);
    setVerified(true);
    setLoading(false);
  }
