...
const checks = [
  ...
  ["Runtime records real provider-call heartbeat evidence", adapter.includes('workerName = "generate-business-build-plan"') && adapter.includes('provider_route: selected.route') && adapter.includes('provider_call_proven: selected.route === "external_provider"') && adapter.includes('local_adapter_call_proven: selected.route === "local_adapter"') && adapter.includes("last_request_fingerprint")],
