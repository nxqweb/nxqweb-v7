...
const checks = [
  ...
  ['Deployment config lookup is bound to exact client and project', worker.includes('.eq("project_id", job.project_id).eq("client_id", job.client_id).maybeSingle()')],
