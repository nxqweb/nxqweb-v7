...
const checks = [
  ...
  ["Commerce upload path is implemented as a dedicated protected worker", commerceUpload.includes("NXQ_AUTOMATION_WORKER_TOKEN") && commerceUpload.includes("commerce")],
