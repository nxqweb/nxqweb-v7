...
["Classifier can handle explicit contact edits deterministically",worker.includes("deterministicResult")&&worker.includes("contact_email")&&worker.includes("contact_phone")],
