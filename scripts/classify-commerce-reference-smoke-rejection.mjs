...
const SAFE_SMOKE_FAILURES = new Map([
  ...
  ["fixture-upload-authorization-rpc-rejection-or-no-data:completed", "commerce-smoke-fixture-upload-authorization-rpc-rejection-or-no-data-cleanup-completed"],
  ["fixture-upload-authorization-payload-structure:completed", "commerce-smoke-fixture-upload-authorization-payload-structure-rejection-cleanup-completed"],
