...
const checks = [
  ...
  ["Exact backend DNS instructions take visual priority", page.includes("Exact NXQ-Web instructions") && page.includes("domain.dns_instructions")],
  ...
  ["Nameserver changes require explicit NXQ-Web direction", guides.includes("Do not change nameservers unless NXQ-Web explicitly says")],
  ...
  ["Automatic checks are clearly separated from client actions", page.includes("NXQ-Web is checking automatically") && page.includes("Your action")],
